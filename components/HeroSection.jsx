...
export default function AntiCounterfeitHero() {
  ...
  return (
    <div className="min-h-screen bg-[#E6E9EE] relative overflow-hidden pt-20 md:pt-8" 
    style={{
      ...
      <div className="relative z-10 container mx-auto px-4  ">
        ...
        {/* Hero Text */}
        <div className={`text-center max-w-7xl mx-auto mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto font-medium">
            Protect your products, your customers, and your reputation — with encrypted NFC smart tags that prove authenticity in seconds.
          </p>
        </div>

        {/* CTA Buttons */}
        <div className={`flex flex-col sm:flex-row justify-center items-center gap-4 mb-16 transition-all duration-1000 delay-400 md:pb-7 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <button className="group bg-gradient-to-b from-gray-700 to-gray-900 border border-gray-700 text-white px-8 py-4 rounded-full flex items-center gap-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
           <Image src={Cloud1} alt="User" width={32} height={32} className="w-8 h-8 rounded-full" />
          ...
          <button className="group bg-white/40 border border-gray-400 text-gray-600 px-8 py-4 rounded-full flex items-center gap-3 opacity-60 cursor-not-allowed">
            <Image src={Cloud2} alt="User" width={32} height={32} className="w-8 h-8 rounded-full" />
...
<div className="relative max-w-6xl mx-auto aspect-[16/9] md:aspect-[16/9] lg:h-[580px] overflow-visible">
  ...
  >
    <div className="flex flex-col items-center gap-2 sm:gap-3">
      <Image src={Right} alt="Verified" width={56} height={56} className="w-8 sm:w-10 md:w-14" />
      <span className="font-semibold text-gray-800 text-xs sm:text-sm md:text-base">Verified</span>
    </div>
  </div>
  ...
  >
    <div className="flex items-center gap-2 sm:gap-3">
      <Image src={Rev} alt="Revolutionary" width={56} height={56} className="w-8 sm:w-10 md:w-14" />
      <div className="text-left">
        <div className="font-semibold text-gray-800 text-xs sm:text-sm md:text-base">Revolutionary</div>
        <div className="font-semibold text-gray-800 text-xs sm:text-sm md:text-base">Technology</div>
      </div>
    </div>
  </div>
  ...
  >
    <div className="flex items-center gap-2 sm:gap-3">
      ...
      <div className="text-left">
        <div className="font-semibold text-gray-800 text-xs sm:text-sm md:text-base">Enhancing</div>
        <div className="font-semibold text-gray-800 text-xs sm:text-sm md:text-base">Customer Experience</div>
      </div>
    </div>
  </div>
</div>
