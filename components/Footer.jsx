      ...
      <div className="max-w-8xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="text-center md:text-left">
          <p className="text-blue-400 text-sm mb-2">
            Be Originals, Buy Originals Verify by Sense Originals
          </p>
...
"
        >
          <Image
            ...
            width={160}
            height={50}
            className="w-24 sm:w-28 md:w-32 lg:w-40 max-w-full object-contain"
          />
          <Image
            src={Client2}
            alt="Client"
            width={200}
            height={60}
            className="w-28 sm:w-32 md:w-40 lg:w-52 max-w-full object-contain"
          />
          <Image
            src={Client3}
            alt="Client"
            width={160}
            height={50}
            className="w-24 sm:w-28 md:w-32 lg:w-30 max-w-full object-contain"
          />
          <Image
            src={Client4}
            alt="Client"
      ...
      <div className="border-t border-gray-700 mt-12 pt-10 flex flex-col md:flex-row md:justify-between gap-10">
        ...
        <div className="flex flex-col gap-3 w-full md:w-64">
          ...
          <div className="flex items-center gap-4 mt-3 text-white text-xl">
            <a href="https://www.instagram.com/sense_original/?hl=en">
              <FaInstagram className="hover:text-pink-400" />
            </a>
            <a href="https://x.com/Senseoriginal_">
              <FaXTwitter className="hover:text-gray-400" />
            </a>
            <a href="https://www.facebook.com/people/Sense-Original/61552099147568/">
              <FaLinkedin className="hover:text-blue-700" />
            </a>
            <a href="https://www.linkedin.com/company/senseoriginal-technologies-pvt-ltd/">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
          <div className="bg-white text-center rounded-xl shadow-lg p-8 w-[90%] md:w-[400px]">
            ...
            <p className="text-gray-600 mb-6">Your email has been successfully submitted.</p>
            <button
