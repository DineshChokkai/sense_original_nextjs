      ...
      <header>
        ...
        >
          <div className="max-w-8xl mx-auto flex items-center justify-between px-4 py-3 md:py-4">
            ...
            <div className="flex items-center gap-2" onClick={handleScrollTop}>
              <Image src="/images/brandlogo.png" alt="Logo" width={32} height={32} className="h-8 w-auto object-contain cursor-pointer" />
            </div>
        ...
        >
          <div className="flex justify-between items-center mb-4">
            <Image src="/images/herologo.png" alt="Logo" width={32} height={32} className="h-8 w-auto object-contain" />
        ...
        <div className="h-full overflow-y-auto">
          <div className="max-w-6xl mx-auto px-6 md:px-12 py-12">
            <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
              {/* Logo */}
              <div className="mb-8">
                <Image src="/images/brandlogo.png" alt="Logo" width={150} height={40} className="w-auto object-contain" />
              </div>
              ...
              <div className="w-full">
                ...
                <p className="text-gray-600 mb-8">
                  Our sales team always active to support you. Any kind of questions about our product they can answer to you.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="agree" className="text-sm text-gray-600">
                      I agree that Sense Original may contact me at the email address or phone number above.
                    </label>
                  </div>
