        ...
        >
              ...
              <thead>
                <tr className="bg-[#F9FAFB] border-b border-[#E5E7EB]">
                  ...
                  <th className="text-center py-6 px-4">
                    <div className="inline-flex items-center justify-center bg-gradient-to-b from-[#3E4046] to-[#131314] text-white px-6 py-3 rounded-[36px] border border-[#333333] text-sm font-semibold leading-5 tracking-[-0.15px] transition-transform duration-300 hover:scale-105" 
              ...
              <thead>
                <tr className="bg-[#F9FAFB] border-b border-[#E5E7EB]">
                  ...
                  <th className="text-center py-5 px-3">
                    <div className="inline-flex items-center justify-center bg-gradient-to-b from-[#3E4046] to-[#131314] text-white px-4 py-2 rounded-[36px] border border-[#333333] text-xs font-semibold" 
                         style={{boxShadow: 'inset 0px 2px 4px 0px rgba(255, 255, 255, 0.1)'}}>
                      SenseOriginal NFC
                    </div>
                  </th>
          ...
          <div className="md:hidden">
            ...
            <div className="bg-[#F9FAFB] border-b border-[#E5E7EB] p-4 text-center">
              <div className="inline-flex items-center justify-center bg-gradient-to-b from-[#3E4046] to-[#131314] text-white px-5 py-2.5 rounded-[36px] border border-[#333333] text-xs font-semibold mb-3"
                   style={{boxShadow: 'inset 0px 2px 4px 0px rgba(255, 255, 255, 0.1)'}}>
                SenseOriginal NFC
              </div>
            </div>
            ...
            <div className="divide-y divide-[#F3F4F6]">
              {features.map((feature, index) => (
                ...
                >
                  <div className="text-sm text-[#101828] font-semibold mb-4">
                    {feature.name}
                  </div>
