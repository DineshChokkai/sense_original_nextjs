...
export const metadata = {
  ...
  openGraph: {
    ...
    title: 'SenseOriginal - Counterfeit Protection & Product Authentication',
    description: 'Advanced NFC-based product authentication. Protect your brand from counterfeits.',
    images: [
      {
  ...
  other: {
    ...
    'msapplication-TileImage': 'https://sense-original-nextjs.vercel.app/opengraph-image.png',
